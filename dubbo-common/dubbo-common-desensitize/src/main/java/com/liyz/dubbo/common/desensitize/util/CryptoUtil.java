...
import com.liyz.dubbo.common.desensitize.exception.DesensitizeException;
import com.liyz.dubbo.common.desensitize.exception.DesensitizeExceptionCodeEnum;
    ...
    public static class Symmetric {
        ...
        public static String encryptDES(String content, String key) {
            ...
            if (Objects.isNull(key) || key.getBytes().length < 8) {
                throw new DesensitizeException(DesensitizeExceptionCodeEnum.DEC_KEY_LENGTH_ERROR);
            }
        ...
        public static String encryptDES(String content, String key, String iv) {
            ...
            if (Objects.isNull(iv) || iv.getBytes().length != 8) {
                throw new DesensitizeException(DesensitizeExceptionCodeEnum.DEC_IV_LENGTH_ERROR);
            }
        ...
        public static String encryptAES(String content, String key, String iv) {
            ...
            if (Objects.isNull(iv) || iv.getBytes().length != 16) {
                throw new DesensitizeException(DesensitizeExceptionCodeEnum.AEC_IV_LENGTH_ERROR);
            }
