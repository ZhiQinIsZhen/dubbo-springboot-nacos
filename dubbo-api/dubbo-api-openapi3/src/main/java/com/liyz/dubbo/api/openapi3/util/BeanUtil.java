package com.liyz.dubbo.api.openapi3.util;

import cn.hutool.core.util.ReflectUtil;
import com.google.common.base.Joiner;
import com.google.common.collect.Lists;
import com.liyz.dubbo.api.openapi3.cglib.SimpleBeanCopier;
...
public class BeanUtil {
    ...
    private static <S, T> SimpleBeanCopier<S, T> getSimpleBeanCopier(final Class<S> sourceClass, final Class<T> targetClass) {
        String key = Joiner.on(":").join(sourceClass.getName(), targetClass.getName());
