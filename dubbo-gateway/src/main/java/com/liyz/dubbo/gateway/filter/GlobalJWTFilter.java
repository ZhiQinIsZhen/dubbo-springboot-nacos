package com.liyz.dubbo.gateway.filter;
...
import com.liyz.dubbo.gateway.properties.AnonymousMappingProperties;
import com.liyz.dubbo.gateway.util.ResponseUtil;
...
public class GlobalJWTFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        String jwt = (Objects.requireNonNull(Objects.isNull(request.getCookies().getFirst(GatewayConstant.AUTHORIZATION)) ?
                new HttpCookie(GatewayConstant.AUTHORIZATION, null) :
                request.getCookies().getFirst(GatewayConstant.AUTHORIZATION))).getValue();
