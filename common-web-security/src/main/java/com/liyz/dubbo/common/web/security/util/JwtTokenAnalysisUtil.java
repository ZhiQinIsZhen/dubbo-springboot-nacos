 ...
 */
@Component
public class JwtTokenAnalysisUtil {

    @Value("${jwt.secret:liyz}")
    ...
    public String generateToken(UserDetails userDetails, Device device, Date date, Long userId) {
    ...
    public Boolean validateToken(String token, UserDetails userDetails, Device device) {
